...
|   |-- 01 Linux Commands
|   |-- 02 IO Redirection
|   |-- 03 Variables and Strings
|   |-- 04 Arrays
|   |-- 05 Conditionals
|   |-- 06 Loops
|   |-- 07 Functions
|   `-- 08 Arguments and Parameters
|-- 02 Red Team Applications
|   |-- Reconnaissance
|   |-- Lateral Movement
|   `-- Exfiltration
|-- 03 Malware Dev and Persistence
|   |-- Payload Generation
...
6 Loop Statements
7 Functions
8 Arguments and Special Parameters
...
3 Grant execution permissions using chmod plus x scriptname.sh.
4 Run the script using dot slash scriptname.sh.
